...
export default async function EditFlagPage({ params }: { params: { id: string, state:any } }) {
  const {id} = params
...
console.log('flagValueType',flagValueType)
  ...
  const tabs = [
      { label: 'Tab 1',component: <TabsContent activeTab={0} flagValueType={flagValueType} /> },
      { label: 'Tab 2',component: <TabsContent activeTab={1} flagValueType={flagValueType} /> },
    ];
